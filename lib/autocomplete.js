...
class AutoCompleteEngine {
    ...
    buildTrie(words) {
        ...
        for (const word of words) {
            if (word && word.length > 0) {
                ...
                // TODO: Check if this slows down the performance:
                // this.trie.insert(word.toLowerCase()); // Ensure case-insensitivity
            }
        }
    ...
    getSuggestions(input, maxResults = this.maxSuggestions) {
        ...
        const suggestions = this.trie.autoComplete(currentWord);
